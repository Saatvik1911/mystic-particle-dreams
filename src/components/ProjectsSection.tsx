    ...
    function createNebulaSystem() {
      ...
      for (let i = 0; i < particleCount; i++) {
        ...
        if (isInCore) {
          ...
          color.setRGB(
            brightness * (0.6 + purpleIntensity * 0.3),
            brightness * (0.3 + purpleIntensity * 0.2),
            brightness * (0.7 + purpleIntensity * 0.2)
          );
        } else {
          ...
          color.setRGB(
            greyBase + reflectionIntensity * brightness * 0.1,
            greyBase + reflectionIntensity * brightness * 0.05,
            greyBase + reflectionIntensity * brightness * 0.15
          );
        }
        colors.push(color.r, color.g, color.b);
